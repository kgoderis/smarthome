...
import org.eclipse.smarthome.core.common.RecurrenceExpression.UntilExpressionPart;
...
public final class CronExpression extends AbstractExpression<CronExpressionPart> {
    ...
    protected abstract class CronExpressionPart extends AbstractExpressionPart {
        ...
        public void parse() throws ParseException {
            valueSet = initialiseValueSet();
            StringTokenizer valueTokenizer = new StringTokenizer(part, ",");
        ...
        void parseToken(String v) throws ParseException {
            switch (getSpecialToken(v)) {
                case "-": {
                    ...
                    valueSet.add(Integer.parseInt(from), Integer.parseInt(to), 1);
                    break;
                }
                case "/": {
                    String from = StringUtils.substringBefore(v, "/");
                    ...
                    valueSet.add(fromValue, MAX_SECOND, Integer.parseInt(increment));
                    break;
                }
                case "*": {
                    valueSet.add(MIN_SECOND, MAX_SECOND, 1);
                    break;
                }
                default: {
                    try {
        ...
        void parseToken(String v) throws ParseException {
            switch (getSpecialToken(v)) {
                ...
                case "/": {
                    ...
                    int fromValue = from.equals("*") ? 0 : Integer.parseInt(from);
                    valueSet.add(fromValue, MAX_MINUTE, Integer.parseInt(increment));
                    break;
                }
                case "*": {
                    valueSet.add(MIN_MINUTE, MAX_MINUTE, 1);
                    break;
                }
                default: {
                    try {
        ...
        void parseToken(String v) throws ParseException {
            switch (getSpecialToken(v)) {
                ...
                case "/": {
                    ...
                    int fromValue = from.equals("*") ? 0 : Integer.parseInt(from);
                    valueSet.add(fromValue, MAX_HOUR, Integer.parseInt(increment));
                    break;
                }
                case "*": {
                    valueSet.add(MIN_HOUR, MAX_HOUR, 1);
                    break;
                }
                default: {
                    try {
        ...
        void parseToken(String v) throws ParseException {
            switch (getSpecialToken(v)) {
                case "-": {
                    String from = StringUtils.substringBefore(v, "-");
                    String to = StringUtils.substringAfter(v, "-");
                    valueSet.add(monthAsInteger(from), monthAsInteger(to), 1);
                    break;
                }
                case "/": {
                    String from = StringUtils.substringBefore(v, "/");
                    ...
                    valueSet.add(fromValue, MAX_MONTH, monthAsInteger(increment));
                    break;
                }
                case "*": {
                    valueSet.add(MIN_MONTH, MAX_MONTH, 1);
                    break;
                }
                default: {
                    try {
                        valueSet.add(monthAsInteger(v));
                    } catch (Exception e) {
                        throw new ParseException("'" + v + "' is not a valid token", 0);
                    }
                    break;
        ...
        void parseToken(String v) throws ParseException {
            switch (getSpecialToken(v)) {
                ...
                case "/": {
                    ...
                    int fromValue = from.equals("*") ? 0 : Integer.parseInt(from);
                    valueSet.add(fromValue, MAX_MONTHDAY, Integer.parseInt(increment));
                    break;
                }
                case "*": {
                    valueSet.add(MIN_MONTHDAY,
        ...
        void parseToken(String v) throws ParseException {
            switch (getSpecialToken(v)) {
                case "-": {
                    String from = StringUtils.substringBefore(v, "-");
                    String to = StringUtils.substringAfter(v, "-");
                    valueSet.add(dayAsInteger(from), dayAsInteger(to), 1);
                    break;
                }
                case "/": {
                    String from = StringUtils.substringBefore(v, "/");
                    ...
                    valueSet.add(fromValue, MAX_DAYWEEK, dayAsInteger(increment));
                    break;
                }
                case "*": {
                    valueSet.add(MIN_DAYWEEK, MAX_DAYWEEK, 1);
                    break;
                }
                case "?": {
                    isNotSpecific = true;
        ...
        void parseToken(String v) throws ParseException {
            switch (getSpecialToken(v)) {
                ...
                case "/": {
                    ...
                    int fromValue = from.equals("*") ? 0 : Integer.parseInt(from);
                    valueSet.add(fromValue, MAX_YEAR, Integer.parseInt(increment));
                    break;
                }
                case "*": {
                    valueSet.add(MIN_YEAR, MAX_YEAR, 1);
                    break;
                }
                default: {
                    try {
